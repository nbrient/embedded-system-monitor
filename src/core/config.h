...
typedef enum {
    LOG_TARGET_JOURNALCTL = 0, /**< systemd journal via sd_journal_send(). */
    LOG_TARGET_SYSLOG     = 1, /**< Traditional openlog() / syslog(). */
} LogTarget;
...
//                                              Public functions
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/** @brief Override the config file path. @param path Path to the YAML file or its parent directory. */
...
/** @brief Parse the YAML config. Falls back to defaults on error. @return Populated MonitorCfg by value. */
