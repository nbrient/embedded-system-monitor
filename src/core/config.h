...
//                                              Public functions
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/** @brief Override the config file path. @param path Path to the YAML file or
...
/** @brief Parse the YAML config. Falls back to defaults on error. @return
 * Populated MonitorCfg by value. */
